...
export default function ProjectLeft(props) {
  return (
    <>
        <div className='container right ' style={{overflow:"hidden"}}>
                    <h2 className='project-img'data-aos="fade-left" data-aos-duration="1000" data-aos-easing="ease-in">
                        <img src={props.img} alt="" />
                    </h2>

                    <div className='Cards Cards-right'data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease-in">
                    <h3 className="card-heading">{props.number}</h3>
                    <h3 className="card-heading">{props.heading}</h3>
                <p className="card-para">{props.discription}</p>
